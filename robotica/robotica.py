...
class Tasks:
    ...
    def add_tasks_to_scheduler(self, scheduler: BaseScheduler):
        scheduler.add_job(self.wake_up, 'cron', hour="06", minute="30", day_of_week="1-5")
        scheduler.add_job(self.wake_up_urgent, 'cron', hour="07", minute="00", day_of_week="1-5")
        scheduler.add_job(self.eat_breakfast, 'cron', hour="07", minute="10", day_of_week="1-5")
        scheduler.add_job(self.clean_teeth, 'cron', hour="07", minute="20", day_of_week="1-5")
        scheduler.add_job(self.get_into_car, 'cron', hour="07", minute="25", day_of_week="1-5")
        scheduler.add_job(self.go_to_bus, 'cron', hour="07", minute="30", day_of_week="1-5")
        ...
        scheduler.add_job(self.make_lunch, 'cron', hour="18", minute="20", day_of_week="0-4")
